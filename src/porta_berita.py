...
class Login(SeleniumDriver):
    ...
    _url_wp_login = "https://ptkaryaagungland.com/wp-login.php"
...
class Template(SeleniumDriver):
    ...
    # Locator
    ######################################
    _url_wp_template = "https://ptkaryaagungland.com/wp-admin/edit.php?post_type=elementor_library&tabs_group=library"
